...
- Configuration
  - [Chatbot Settings](configuration/settings.md)
  - [Keyword Replies](configuration/keywords.md)
  - [Conversation Flows](configuration/flows.md)
  - [AI Integration](configuration/ai.md)

- Features
  - [Script Responses](features/scripts.md)
...
- Examples
  ...
  - [Lead Collection](examples/lead-collection.md)
  - [Order Status](examples/order-status.md)
  - [Support Flow](examples/support-flow.md)
